...
#     'scheme': 'https',
#     'cookie': 'mid=YIZ9egALAAH-iH_vYRiiNxd0St4Q; ig_did=45802912-703C-42C1-AD51-003FC06D468D; ig_nrcb=1; csrftoken=vXG3ERpoDG0zE9SVXD7xNZnFutBDg205; ds_user_id=47488088274; sessionid=47488088274%3AifxJVzYvuh6uSV%3A13; rur=FRC',
#     'referer': 'https://www.instagram.com/skuukzky/followers/?hl=zh-cn',
#     'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36',
#     'x-csrftoken': 'vXG3ERpoDG0zE9SVXD7xNZnFutBDg205',
#     'x-ig-app-id':'936619743392459',
#     'x-ig-www-claim': 'hmac.AR1YhrfvM-jeH864z0V9L-jgYgwYbrND_22a8G-gGZ5wMTYs',
...
def get_content(url,headers):
    ...
    try:
        ...
        print(e)
        return None
def get_urls(html,headers,number):
    time.sleep(10)
    id, username,user_id = '', '', ''
    ...
    for item in items:
        if item.text().strip().startswith('window._sharedData'):
            ...
            df.to_csv('user_csv'+str(number)+'.csv', mode='a',index=None,encoding="utf-8")
            ...
            'comment_count','like_count','img_urls','post_text_len','#_count','@_count'])
                ...
                df.to_csv('post_csv'+str(number)+'.csv', mode='a',index=False,encoding="utf-8")
...
def main(user,headers,number):
    get_urls(get_html(url_base.format(user,headers),headers),headers,number)
